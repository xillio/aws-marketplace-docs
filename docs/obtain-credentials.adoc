...
postgresql_password=7eEhC0J5aY1VDt2N7Eq8GVJKMZA46jzkwQvvNbVmmecerGYnfm
----
7. Press `ctrl+x > y > Enter` to save the changes.

[#system-logs]
=== Method 2: From EC2 System Logs

TIP: The system log is only available the first 12 hours after you first start the instance. It may also take up to 20
...
+
image::./images/read-log.png__[align="center"]__
